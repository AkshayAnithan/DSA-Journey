...
Pattern notes and audited problem records for ordered search, bounds, rotated search, and monotonic predicates.
...
- [Time Based Key-Value Store: Rightmost Valid Timestamp](Time-Based-Key-Value-Store.md)