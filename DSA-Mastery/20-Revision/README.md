...
| 2026-08-30 | Find Minimum in Rotated Sorted Array | Reconstruction | Re-code the compact C++ version from blank; explain why `right = mid` | Solution-dependent; repeat after retrieving the midpoint-versus-boundary discard rule |
