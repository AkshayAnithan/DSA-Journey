...
| 2026-08-28 | Buy and Sell Crypto | Discovery | Bottleneck unidentified | Had the $O(n^2)$ pair enumeration but could not reduce each sell day to a prefix summary | State the repeated scan, then name the one past value that dominates every other candidate | 2026-08-29 | Pending |